...
// --------------------------------- arrays of matrices --------------------------------------------------
      ...
      // the following solution is available. Here we create an array of 10 matrices, each of dimensions 2x4.
      ...
      DMatrix4D *tab2 = DMatrix4D::makeArray(8,6,5);
...
// --------------------------------- indexing ------------------------------------------------------------
      ...
      {
         for(int j=1;j<=(int)P.numberOfColumns();++j)
         {
